    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        if (clientOS == 0){
            ...
            System.out.println("версии приложений для других ОС в разработке..)");
        }

        /*2
         К нам пришли коллеги и сообщили, что нам нужно знать не только операционную систему телефона,
        но и год его создания: от этого зависит, подойдет ли приложение для телефона или оно просто не установится.  (...привет Slack)
        ...
        * */
        ...
        int year = clientDeviceYear;
        if (year % 400 == 0) {
                System.out.println("Поздравляю Вы купили телефон в "+ year +" високосный год");
        } else if (year % 4 == 0 && year % 100 != 0) {
                System.out.println("Поздравляю Вы купили телефон в "+ year +" високосный год");
        }else {
            System.out.println("Увы.. Вы купили телефон в "+ year +" невисокосный год");
        }
        ...
        * */
        ...
        if (deliveryDistance <= 20){
            ...
            System.out.println("Заберите в ближайшем отделении банка");
        }
